					...
					$.ajax({
						...
						success: function (result) {
							...
							if (resultObj.success) {
								...
								// Show error.
								$('.fs-content').prepend('<div class="fs-error">' + (resultObj.error.message ?  resultObj.error.message : resultObj.error) + '<br>' + '<a href="https://www.youtube.com/watch?v=KZ8yHBdGaPQ" target="_blank" class="wpr-fs-error-video-tutorial">Watch Video Tutorial</a>' + '</div>');
							}
						},
						error: function () {
							resetLoadingMode();
