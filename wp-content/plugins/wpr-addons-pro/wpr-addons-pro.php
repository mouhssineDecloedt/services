...
define( 'WPR_ADDONS_PRO_VERSION', '1.5.7' );
...
if ( function_exists( 'wpr_fs' ) ) {
    ...
    global $wpr_fs;
    if ( ! isset( $wpr_fs ) ) {
        // Fallback class definition if the Freemius SDK isn't loaded.
        if ( ! class_exists( 'wpr_fs_null' ) ) {
            class wpr_fs_null {
                ...
                // Dummy set_basename method to prevent undefined method error.
                public function set_basename( $flag, $file ) {
                    // This method is intentionally left empty.
                }
            }
        }
        // Include the Freemius SDK if it's available.
